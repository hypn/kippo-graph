 ...
 * Visualisation type: intensity map
 * @author Thomas Schäfer
 * @since 2008-06-29
 *
 */
class QIntensitymapGoogleGraph extends QVizualisationGoogleGraph {
	 ...
	 * @var string
	 */
	protected $vizualisationType = "IntensityMap";
