...
<div class="wrapper">
  <div class="container">
    <div class="whitebox">
      ...
      <h3>Statistics are not updated in real time. To start, you will have to manually <a href="kippo-graph-generator.php">GENERATE_THE_KIPPO_GRAPHS();</a></h3>
	  <p><hr></p>
	  ...
	  #Website: bruteforce.gr/kippo-graph
		...
		if(UPDATE_CHECK == 'YES')
		{
			if(isUpToDate()) {
				...
				echo " - There is a <strong>new</strong> version available for <a href='http://bruteforce.gr/kippo-graph' target='_blank'>download</a>!\n";
			}
		}
	  ?></p>
	  <p>&nbsp;</p>
	  ...
	  <p>&nbsp;</p>
	  <p class="fl_right"><small><a href="http://www.freedigitalphotos.net/images/view_photog.php?photogid=2280">Image: digitalart / FreeDigitalPhotos.net</a></small></p>
      <!-- ####################################################################################################### -->
      <div class="clear"></div>
    </div>
  </div>
