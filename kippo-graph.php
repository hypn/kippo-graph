  ...
  <div class="container">
    <div class="whitebox">
      ...
      <div class="portfolio">
        ...
        <div class="fl_right"><img src="generated-graphs/most_successful_logins_per_day.png<?php echo '?'.$last_updated; ?>" alt="" /></div>
		<div class="clear"></div>
		<div class="fl_left">
      ...
      <div class="portfolio">
        ...
        <div class="fl_right"><img src="generated-graphs/most_probes_per_day.png<?php echo '?'.$last_updated; ?>" alt="" /></div>
		<div class="fl_left">
